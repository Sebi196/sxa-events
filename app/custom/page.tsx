...
export default function CustomPackage() {
  ...
  const handleOffer = () => {
    ...
    const serviciiMesaj = selectedServices
      .map((service) => {
        const quantity =
          service.perPerson || service.perPiece
            ? service.quantity || 1
        ...
        if (
          ...
          text += `\n  ${quantity} ${
            service.perPerson ? "persoane" : "bucăți"
...
Doresc să solicit o ofertă pentru următorul pachet personalizat:
...
Aștept confirmarea și oferta finală.
